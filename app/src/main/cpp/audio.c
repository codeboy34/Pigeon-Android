...
JNIEXPORT jint Java_com_pigeon_widget_audio_OpusAudioRecorder_startRecord(JNIEnv *env, jobject frame, jstring path) {
...
JNIEXPORT jint Java_com_pigeon_widget_audio_OpusAudioRecorder_writeFrame(JNIEnv *env,jobject frame,jshortArray array,jint len) {
...
JNIEXPORT void Java_com_pigeon_widget_audio_OpusAudioRecorder_stopRecord(JNIEnv *env, jobject frame) {
...
JNIEXPORT jbyteArray Java_com_pigeon_widget_audio_OpusAudioRecorder_getWaveform2(JNIEnv *env, jobject frame, jshortArray array, jint length) {
    jshort *sampleBuffer = (*env)->GetShortArrayElements(env, array, 0);
