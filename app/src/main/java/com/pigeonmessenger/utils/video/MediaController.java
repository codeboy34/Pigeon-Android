...
public class MediaController {
    ...
    public boolean convertVideo(String videoPath, int bitrate, int resultWidth, int resultHeight, int
        ...
        if (!needChange) {
            //Todo uncomment to make video convert
        ...
        /*
        if (rotationValue.equals("90")) {
            int temp = resultHeight;
            resultHeight = resultWidth;
            resultWidth = temp;
            rotateRender = 270;
        } else if (rotationValue.equals("180")) {
            rotateRender = 180;
        } else if (rotationValue.equals("270")) {
            int temp = resultHeight;
            resultHeight = resultWidth;
            resultWidth = temp;
            rotateRender = 90;
        ...
        SharedPreferences preferences = App.get().getSharedPreferences("videoconvert", Activity.MODE_PRIVATE);
