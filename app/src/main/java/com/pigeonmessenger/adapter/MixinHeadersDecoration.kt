...
class MixinHeadersDecoration private constructor(
    private val mAdapter: PigeonStickyRecyclerHeadersAdapter<*>,
    ...
    constructor(adapter: PigeonStickyRecyclerHeadersAdapter<*>) : this(adapter,
        LinearLayoutOrientationProvider(), DimensionCalculator())

    private constructor(
        adapter: PigeonStickyRecyclerHeadersAdapter<*>,
