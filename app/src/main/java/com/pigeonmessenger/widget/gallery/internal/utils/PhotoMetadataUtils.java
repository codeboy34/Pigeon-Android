package com.pigeonmessenger.widget.gallery.internal.utils;
...
import com.pigeonmessenger.widget.gallery.filter.Filter;
import com.pigeonmessenger.widget.gallery.internal.entity.IncapableCause;
...
public final class PhotoMetadataUtils {
    ...
    private static boolean shouldRotate(ContentResolver resolver, Uri uri) {
        ...
        try {
            ...
            Log.e("PhotoMetadata","could not read exif info of the image :"+ uri);
            return false;
        }
    ...
    public static float getSizeInMB(long sizeInBytes) {
        ...
        Log.e("PhotoMetadata","getSizeInMB: "+ result);
