...
import com.pigeonmessenger.widget.PlayView
import com.pigeonmessenger.widget.PlayView.Companion.STATUS_BUFFERING
import com.pigeonmessenger.widget.PlayView.Companion.STATUS_IDLE
import com.pigeonmessenger.widget.PlayView.Companion.STATUS_LOADING
import com.pigeonmessenger.widget.PlayView.Companion.STATUS_PAUSING
import com.pigeonmessenger.widget.PlayView.Companion.STATUS_PLAYING
import com.pigeonmessenger.widget.fadeIn
import com.pigeonmessenger.widget.fadeOut
import com.pigeonmessenger.widget.gallery.MimeType
import com.pigeonmessenger.widget.photoView.DismissFrameLayout
import com.pigeonmessenger.widget.photoView.PhotoView
...
class DragMediaActivity : AppCompatActivity(), DismissFrameLayout.OnDismissListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        Observable.just(conversationId).observeOn(Schedulers.io())
            ...
            .subscribe { list ->
                index = list.indexOfFirst { item -> messageId == item.id }
                list.map {
    ...
    inner class MediaAdapter(
        ...
        fun getItem(position: Int): MessageEntity = list!![position]
        ...
        private fun createVideoView(container: ViewGroup, position: Int, messageItem: MessageEntity): View {
            ...
            view.setOnClickListener {
                if (view.controller.visibility== View.VISIBLE) {
                    fadeOut(view)
                } else {
                    fadeIn(view)
                }
        ...
        private fun setSize(messageItem: MessageEntity, view: View, post: Boolean) {
        ...
        private fun createLargeImageView(container: ViewGroup, position: Int, messageItem: MessageEntity): LargeImageView {
        ...
        private fun createPhotoView(container: ViewGroup, position: Int, messageItem: MessageEntity): PhotoView {
        ...
        fun show(activity: Activity, imageView: View, messageItem: MessageItem?) {
            messageItem?.let {
                val intent = Intent(activity, DragMediaActivity::class.java).apply {
                    putExtra(CONVERSATION_ID, messageItem.senderId)
                    putExtra(MESSAGE_ID, messageItem.id)
                }
